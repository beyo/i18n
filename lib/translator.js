...
function * translateMessage(translator, internal, msgId, options) {
  ...
  if ((msgText !== null) && (typeof msgText === 'object')) {
    pluralKey = localeSpecs && options && ('plurality' in options) ? localeSpecs.plural(options.plurality) : C.MESSAGE_OTHER;

    msgText = msgText[pluralKey] || msgText[C.MESSAGE_OTHER] || msgText;
  }
