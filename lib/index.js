...
Object.defineProperty(module.exports, 'getCatalog', {
  configurable: false,
  enumerable: true,
  writable: false,
  value: function(locale) {
    return getGlobalTranslator().getCatalog(locale);
  }
});
...
Object.defineProperty(module.exports, 'translate', {
  ...
  value: function(message, options) {
    return getGlobalTranslator().translate(message, options);
  }
});
...
module.exports.init = function init(options, callback) {
  globalTranslator = new Translator(options, callback);
